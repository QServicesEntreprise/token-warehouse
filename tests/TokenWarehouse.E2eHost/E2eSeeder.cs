        ...
        CancellationToken cancellationToken)
    {
        var fixtureArticles = new[]
        {
            new ArticleEntity
            {
                ...
                NameSearchKey = SearchKey("Alimentaire aux deux modes"),
                PriceHtCents = 100,
                IsActive = true,
            ...
            new ArticleEntity
            {
                ...
                NameSearchKey = SearchKey("Alimentaire à DLC dépassée"),
                PriceHtCents = 100,
                IsActive = true,
                Dlc = "2020-01-14",
            ...
            new ArticleEntity
            {
                ...
                NameSearchKey = SearchKey("Article archivé"),
                PriceHtCents = 100,
                IsActive = false,
            ...
            new ArticleEntity
            {
                ...
                NameSearchKey = SearchKey("Non alimentaire au Packaging Invendable"),
                PriceHtCents = 100,
                IsActive = true,
            ...
            new ArticleEntity
            {
                ...
                NameSearchKey = SearchKey("Article actif vendable"),
                PriceHtCents = 100,
                IsActive = true,
                Packaging = "new"
            },
            new ArticleEntity
            {
                ...
                NameSearchKey = SearchKey("Article actif sans position"),
                PriceHtCents = 100,
                IsActive = true,
                Dlc = today.ToString("yyyy-MM-dd", CultureInfo.InvariantCulture),
